...
NotebookDataLength[     10706,        228]
NotebookOptionsPosition[     11109,        219]
NotebookOutlinePosition[     11711,        243]
CellTagsIndexPosition[     11668,        240]
WindowFrame->Normal*)
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`\[Sigma]11$$ = 
    1.0500000000000003`, $CellContext`\[Sigma]12$$ = -0.08000000000000007, \
$CellContext`\[Sigma]13$$ = -1.63, $CellContext`\[Sigma]22$$ = 
    0.41000000000000014`, $CellContext`\[Sigma]23$$ = -2.03, $CellContext`\
\[Sigma]33$$ = -1.63, $CellContext`\[Phi]\[Theta]$$ = {1.398008730847458, 
    1.0053096491487339`}, Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    ...
    False, $CellContext`\[Sigma]11$19977$$ = 
    0, $CellContext`\[Sigma]12$19978$$ = 0, $CellContext`\[Sigma]13$19979$$ = 
    0, $CellContext`\[Sigma]22$19980$$ = 0, $CellContext`\[Sigma]23$19981$$ = 
    0, $CellContext`\[Sigma]33$19982$$ = 
    0, $CellContext`\[Phi]\[Theta]$19983$$ = {0, 0}}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`\[Sigma]11$$ = 
        ...
        Hold[$CellContext`\[Sigma]11$$, $CellContext`\[Sigma]11$19977$$, 0], 
        Hold[$CellContext`\[Sigma]12$$, $CellContext`\[Sigma]12$19978$$, 0], 
        Hold[$CellContext`\[Sigma]13$$, $CellContext`\[Sigma]13$19979$$, 0], 
        Hold[$CellContext`\[Sigma]22$$, $CellContext`\[Sigma]22$19980$$, 0], 
        Hold[$CellContext`\[Sigma]23$$, $CellContext`\[Sigma]23$19981$$, 0], 
        Hold[$CellContext`\[Sigma]33$$, $CellContext`\[Sigma]33$19982$$, 0], 
        Hold[$CellContext`\[Phi]\[Theta]$$, \
$CellContext`\[Phi]\[Theta]$19983$$, {0, 0}]}, 
      "OtherVariables" :> {
...
(*NotebookFileOutline
Notebook[{
Cell[1464, 33, 9641, 184, 620, "Output"]
}
]
*)
...
(* NotebookSignature uuTepkLzmDqQKDwIMwX2ZvVw *)
